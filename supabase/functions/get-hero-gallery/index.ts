...
serve(async (req: Request) => {
  ...
  try {
    ...
    // ── Issue covers ──────────────────────────────────────────────────────────
    // The character's first 20 issue appearances, each with its cover image.
    ...
    // ── Persist to DB ─────────────────────────────────────────────────────────
    // gallery_enriched_at is the sentinel: set unconditionally so heroes with no
    // covers don't re-trigger this fetch on every visit.
