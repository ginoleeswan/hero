-- Add avatar_url to the social-web graph nodes. Graph nodes are 40-52px circles,
-- where a cropped comic cover is unreadable; the flat icon avatar is drawn for
-- exactly that size. Only the node_rows CTE changes.
