...
-- pages people open most. Measured against the live API, dropping the column
-- from the hero-row select took Spider-Man from 447,000 bytes to 22,070.
--
...
-- `select=...,has_description` — see src/lib/db/heroes/columns.ts.
