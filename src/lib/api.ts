...
import type { HeroDetails, FirstIssue, MovieAppearance } from '../types';
...
// Thrown when a hero id doesn't exist in the catalog — as opposed to a
// transient network/server failure, which throws a plain Error. The character
// screen branches on this to show "Hero not found" vs. a retryable load error.
