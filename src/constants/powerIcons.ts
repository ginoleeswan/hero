...
export const POWER_ICONS: Record<string, PowerIconDef> = {
  // Physical
  strength: { icon: 'barbell', gradientStart: '#ff8a8a', gradientEnd: '#c0392b', category: 'physical' },
  flight: { icon: 'airplane', gradientStart: '#a5f3fc', gradientEnd: '#0e7490', category: 'physical' },
  ...
  reflexes: { icon: 'flash', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'physical' },
  stamina: { icon: 'fitness', gradientStart: '#6ee7b7', gradientEnd: '#047857', category: 'physical' },
  ...
  underwater: { icon: 'water', gradientStart: '#a5f3fc', gradientEnd: '#0e7490', category: 'physical' },
  aquatic: { icon: 'water', gradientStart: '#a5f3fc', gradientEnd: '#0e7490', category: 'physical' },

  // Defensive (physical)
  invulner: { icon: 'shield-checkmark', gradientStart: '#6ee7b7', gradientEnd: '#047857', category: 'physical' },
  durability: { icon: 'shield', gradientStart: '#6ee7b7', gradientEnd: '#047857', category: 'physical' },
  healing: { icon: 'medkit', gradientStart: '#86efac', gradientEnd: '#15803d', category: 'physical' },
  regenerat: { icon: 'medkit', gradientStart: '#86efac', gradientEnd: '#15803d', category: 'physical' },
  ...
  shrink: { icon: 'resize', gradientStart: '#fde68a', gradientEnd: '#b45309', category: 'physical' },

  // Mental
  telepathy: { icon: 'pulse', gradientStart: '#93c5fd', gradientEnd: '#1d4ed8', category: 'mental' },
  telekinesis: { icon: 'planet', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  'mind control': { icon: 'pulse', gradientStart: '#93c5fd', gradientEnd: '#1d4ed8', category: 'mental' },
  precognit: { icon: 'eye', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  intelligence: { icon: 'library', gradientStart: '#93c5fd', gradientEnd: '#1e40af', category: 'mental' },
  ...
  // Energy
  'force field': { icon: 'shield', gradientStart: '#6ee7b7', gradientEnd: '#065f46', category: 'energy' },
  'heat vision': { icon: 'eye', gradientStart: '#fed7aa', gradientEnd: '#c2410c', category: 'energy' },
  ...
  radiation: { icon: 'nuclear', gradientStart: '#d9f99d', gradientEnd: '#4d7c0f', category: 'energy' },
  ...
  lightning: { icon: 'thunderstorm', gradientStart: '#fef08a', gradientEnd: '#a16207', category: 'energy' },
  storm: { icon: 'thunderstorm', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'energy' },
  weather: { icon: 'thunderstorm', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'energy' },
  wind: { icon: 'cloud', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'energy' },
  magnetic: { icon: 'magnet', gradientStart: '#fca5a5', gradientEnd: '#dc2626', category: 'energy' },
  ...
  // Tech
  technopathy: { icon: 'hardware-chip', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'tech' },
  cyber: { icon: 'hardware-chip', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'tech' },

  // Mystic / transformation / exotic
  immortal: { icon: 'infinite', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },
  ...
  transform: { icon: 'refresh', gradientStart: '#99f6e4', gradientEnd: '#0f766e', category: 'mystic' },
  intangib: { icon: 'water', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'mystic' },
  teleport: { icon: 'swap-horizontal', gradientStart: '#c4b5fd', gradientEnd: '#7c3aed', category: 'mystic' },
  invisib: { icon: 'eye-off', gradientStart: '#cbd5e1', gradientEnd: '#475569', category: 'mystic' },
  time: { icon: 'hourglass', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },
  magic: { icon: 'color-wand', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'mystic' },
  sorcery: { icon: 'color-wand', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'mystic' },
  ...
  detective: { icon: 'search', gradientStart: '#93c5fd', gradientEnd: '#1d4ed8', category: 'mental' },
  martial: { icon: 'hand-left', gradientStart: '#fca5a5', gradientEnd: '#b91c1c', category: 'combat' },
  combat: { icon: 'hand-left', gradientStart: '#fca5a5', gradientEnd: '#b91c1c', category: 'combat' },
  marksman: { icon: 'locate', gradientStart: '#cbd5e1', gradientEnd: '#475569', category: 'combat' },
  ...
  stealth: { icon: 'eye-off', gradientStart: '#cbd5e1', gradientEnd: '#475569', category: 'combat' },
