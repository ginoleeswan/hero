...
export const POWER_ICONS: Record<string, PowerIconDef> = {
  ...
  speed: { icon: 'run-fast', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'physical' },
  ...
  // Sensory (physical)
  'x-ray': { icon: 'magnify-scan', gradientStart: '#93c5fd', gradientEnd: '#1d4ed8', category: 'physical' },
  ...
  // Size (physical)
  size: { icon: 'arrow-expand-all', gradientStart: '#fde68a', gradientEnd: '#b45309', category: 'physical' },
  giant: { icon: 'arrow-expand-all', gradientStart: '#fde68a', gradientEnd: '#b45309', category: 'physical' },
  shrink: {
  ...
  precognit: { icon: 'crystal-ball', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  intelligence: {
    icon: 'brain',
    gradientStart: '#93c5fd',
    gradientEnd: '#1e40af',
  ...
  freeze: { icon: 'snowflake', gradientStart: '#e0f2fe', gradientEnd: '#0284c7', category: 'energy' },
  cold: { icon: 'snowflake', gradientStart: '#e0f2fe', gradientEnd: '#0284c7', category: 'energy' },
  electric: { icon: 'lightning-bolt', gradientStart: '#fef08a', gradientEnd: '#ca8a04', category: 'energy' },
  lightning: {
    icon: 'lightning-bolt',
  ...
  wind: { icon: 'weather-windy', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'energy' },
  magnetic: {
    icon: 'magnet',
  ...
  cosmic: { icon: 'star-four-points', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'energy' },
  sonic: { icon: 'volume-high', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'energy' },
  light: { icon: 'white-balance-sunny', gradientStart: '#fef08a', gradientEnd: '#ca8a04', category: 'energy' },
  illumin: { icon: 'white-balance-sunny', gradientStart: '#fef08a', gradientEnd: '#ca8a04', category: 'energy' },
  ...
  intangib: { icon: 'ghost-outline', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'mystic' },
  teleport: {
  ...
  time: { icon: 'timer-sand', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },
  magic: {
    icon: 'magic-staff',
    gradientStart: '#fde68a',
    gradientEnd: '#d97706',
  ...
  dark: { icon: 'weather-night', gradientStart: '#cbd5e1', gradientEnd: '#1e293b', category: 'mystic' },
  shadow: { icon: 'weather-night', gradientStart: '#cbd5e1', gradientEnd: '#334155', category: 'mystic' },
  ...
  intellect: { icon: 'brain', gradientStart: '#93c5fd', gradientEnd: '#1e40af', category: 'mental' },
  detective: {
    icon: 'magnify',
    gradientStart: '#93c5fd',
    gradientEnd: '#1d4ed8',
  ...
  weapon: { icon: 'crosshairs', gradientStart: '#cbd5e1', gradientEnd: '#475569', category: 'combat' },
  ...
  hearing: { icon: 'ear-hearing', gradientStart: '#93c5fd', gradientEnd: '#1d4ed8', category: 'physical' },
  ...
  mariner: { icon: 'anchor', gradientStart: '#a5f3fc', gradientEnd: '#0e7490', category: 'physical' },
  levitat: { icon: 'arrow-up-bold', gradientStart: '#a5f3fc', gradientEnd: '#0e7490', category: 'physical' },
  elastic: { icon: 'arrow-expand-horizontal', gradientStart: '#fde68a', gradientEnd: '#b45309', category: 'physical' },
  density: { icon: 'weight', gradientStart: '#6ee7b7', gradientEnd: '#047857', category: 'physical' },
  ...
  // Combat & skill
  track: { icon: 'map-marker-path', gradientStart: '#93c5fd', gradientEnd: '#1d4ed8', category: 'combat' },
  escape: { icon: 'lock-open-variant', gradientStart: '#cbd5e1', gradientEnd: '#475569', category: 'combat' },

  // Mental & psychic
  astral: { icon: 'meditation', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  ...
  psychometr: { icon: 'history', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  postcognit: { icon: 'history', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  lingual: { icon: 'translate', gradientStart: '#93c5fd', gradientEnd: '#1e40af', category: 'mental' },
  hypnos: { icon: 'eye-circle-outline', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  mesmer: { icon: 'eye-circle-outline', gradientStart: '#c4b5fd', gradientEnd: '#6d28d9', category: 'mental' },
  ...
  vibrat: { icon: 'sine-wave', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'energy' },
  construct: { icon: 'cube-outline', gradientStart: '#6ee7b7', gradientEnd: '#065f46', category: 'energy' },
  absor: { icon: 'tray-arrow-down', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'energy' },
  ...
  hologra: { icon: 'cube-scan', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'tech' },
  electronic: { icon: 'power-plug', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'tech' },

  // Mystic & exotic
  illusion: { icon: 'drama-masks', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'mystic' },
  ...
  duplicat: { icon: 'content-duplicate', gradientStart: '#99f6e4', gradientEnd: '#0f766e', category: 'mystic' },
  mimic: { icon: 'content-copy', gradientStart: '#99f6e4', gradientEnd: '#0f766e', category: 'mystic' },
  chameleon: { icon: 'palette', gradientStart: '#99f6e4', gradientEnd: '#0f766e', category: 'mystic' },
  phas: { icon: 'ghost-outline', gradientStart: '#bae6fd', gradientEnd: '#0369a1', category: 'mystic' },
  possess: { icon: 'ghost', gradientStart: '#cbd5e1', gradientEnd: '#1e293b', category: 'mystic' },
  probab: { icon: 'dice-multiple', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },
  reality: { icon: 'cube-outline', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },
  dimension: { icon: 'cube-outline', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },
  divine: { icon: 'star-shooting', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'mystic' },
  animat: { icon: 'creation', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'mystic' },
  longevity: { icon: 'clock-outline', gradientStart: '#a5b4fc', gradientEnd: '#3730a3', category: 'mystic' },

  // Other / misc
  siphon: { icon: 'water-pump', gradientStart: '#a5b4fc', gradientEnd: '#4338ca', category: 'mystic' },
  item: { icon: 'diamond-stone', gradientStart: '#fde68a', gradientEnd: '#d97706', category: 'mystic' },
  rich: { icon: 'cash-multiple', gradientStart: '#bbf7d0', gradientEnd: '#15803d', category: 'other' },
  eating: { icon: 'food-drumstick', gradientStart: '#fed7aa', gradientEnd: '#ea580c', category: 'other' },
  blood: { icon: 'blood-bag', gradientStart: '#fca5a5', gradientEnd: '#b91c1c', category: 'other' },
  pheromone: { icon: 'flower', gradientStart: '#fbcfe8', gradientEnd: '#be185d', category: 'other' },
};
