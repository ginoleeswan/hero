...
const styles = StyleSheet.create({
  ...
  block: { gap: 10 },
  heading: { fontFamily: 'Flame-Regular', fontSize: 18, color: COLORS.navy },
  factRow: { flexDirection: 'row', gap: 8 },
  bullet: { fontFamily: 'FlameSans-Regular', fontSize: 15, color: COLORS.navy },
  factText: {
    flex: 1,
  ...
  explainer: { gap: 2 },
  explainerName: { fontFamily: 'Nunito_700Bold', fontSize: 14, color: COLORS.navy },
  explainerText: { fontFamily: 'FlameSans-Regular', fontSize: 15, lineHeight: 22, color: COLORS.navy },
  eraText: { fontFamily: 'FlameSans-Regular', fontSize: 15, lineHeight: 22, color: COLORS.navy },
});
